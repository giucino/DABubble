...
export class CustomDialogService {
  ...
  public openDialogAbsolute(button: HTMLElement,dialogComponent : ComponentType<any>, position: 'left' | 'right', mobilePosition? : 'mid' | 'bottom') {
  ...
  updateDialogPosition(button: HTMLElement, position: 'left' | 'right', mobilePosition? : 'mid' | 'bottom'): void {
    if (this.dialogRef) {
      // const rect = button.getBoundingClientRect();
  ...
  getPosition(button: HTMLElement,position : 'left' | 'right', mobilePosition? : 'mid' | 'bottom') {
